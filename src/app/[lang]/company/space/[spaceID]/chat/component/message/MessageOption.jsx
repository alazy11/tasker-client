...
export default function MessageOption({setMessageOptionModel, folderInfo, folderLeft, folderTop,user, spaceID, projectID, setNotification,setMessage,setReferesh,referesh }) {
   ...
   return (
      <>
      <DropDownModel setShowIcon={setMessageOptionModel}>
