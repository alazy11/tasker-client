...
function allowSend(spaceID,employee_id,isLocked,roomId,username,setNotification,setMessage,setTitle) {
    ...
    fetch(
        ...
        .then((data) => {
            if (data.status === "fail" || data.status === "error") {
                ...
                setMessage(`${username} has been Allowed to send message Successfully.`);
                setTitle(`Allow to send`);
...
export default function LockList({spaceID,roomId,lockListMembers,setMessage,setTitle,setNotification}) {
...
<div className="p-2">
            ...
            {
            lockListMembers.map((member, index)=>{
                return (
...
<div>
                        ...
                        <div className="ltr:ml-auto rtl:mr-auto">
                            ...
                            onClick={(e)=>{
                                ...
                                allowSend(spaceID,employee_id,false,roomid,username,setNotification,setMessage,setTitle);
                            }}>
                           Allow
                                </button>
                            </div>
