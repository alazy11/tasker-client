...
function getSubFolder(
   ...
   fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/folder/${folderID}`,
      {
         credentials: "include",
         headers: {
...
export default function FolderTree({
   ...
   useEffect(() => {
      ...
      fetch(
         `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/folder`,
         {
