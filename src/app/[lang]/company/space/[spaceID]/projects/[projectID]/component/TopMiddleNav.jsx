...
<svg width={'100%'} height={'100%'} className="text-inherit" viewBox="0 0 16 16">
   <path fillRule="evenodd" stroke="transparent" d="M1.333 4.667C1.333 4.298 1.632 4 2 4h6.667a.667.667 0 0 1 0 1.333H2a.667.667 0 0 1-.667-.666zM6.667 8c0-.368.298-.667.666-.667H14a.667.667 0 0 1 0 1.334H7.333A.667.667 0 0 1 6.667 8zM4 11.333c0-.368.298-.666.667-.666h6.666a.667.667 0 1 1 0 1.333H4.667A.667.667 0 0 1 4 11.333z" clipRule="evenodd"></path>
</svg>
