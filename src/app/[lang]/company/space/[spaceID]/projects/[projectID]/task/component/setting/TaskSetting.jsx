...
export default function TaskSetting({setSetting,setSettingClose,settingClose,spaceID,projectID,
    setManagerModel,
    setManager,
    manager,
    setTop,
    ...
    return (
        <SettingModel setSetting={setSetting} 
        height='calc(100% - 97px)'
        top='97px'
        setSettingClose={setSettingClose} settingClose={settingClose} >
