...
function removeFromBlockList(spaceID,employee,projectID,setBlockListMembers,username,setNotification,setMessage,setTitle) {

    fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/task/setting/block?employee=${employee}`,
        {
            method:'DELETE',
            credentials: "include",
            headers: {
...
function BlockUser(spaceID,employeei,projectID,setBlockListMembers,username,setNotification,setMessage,setTitle) {

    console.log("employee",employeei[0].employee_id)

    fetch(
       `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/task/setting/block`,
        {
            method:'POST',
            credentials: "include",
            headers: {
            ...
            body:JSON.stringify({employee:employeei[0].employee_id})
        }
    )
        .then((res) => {
            return res.json();
...
export default function BlockList({spaceID,roomId,blockListMembers,setMessage,setTitle,setNotification,
    setBlockListMembers,
    setManagerModel,
    setManager,
    manager,
    ...
    useEffect(()=>{
        ...
        if(manager.length > 0 && again) {
            BlockUser(spaceID,manager,projectID,setBlockListMembers,manager[0].public_name,setNotification,setMessage,setTitle);
        }
...
<div>
                        ...
                        <div className="ltr:ml-auto rtl:mr-auto">
                            ...
                            onClick={(e)=>{
                                ...
                                removeFromBlockList(spaceID,employee_id,projectID,setBlockListMembers,username,setNotification,setMessage,setTitle);
                            }}>
                           Remove
                                </button>
                            </div>
            ...
            <div className="flex pt-16">
                ...
                <div className="cu-view-sidebar-fields-manage-footer__horizontal">
                    <div className="w-full">
                        <button className="btn-normal w-full" onClick={(e)=>{
