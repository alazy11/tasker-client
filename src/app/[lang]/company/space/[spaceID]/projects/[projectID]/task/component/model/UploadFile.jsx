...
const HandleUploadFile =(spaceID, projectID,selectedFile,setLoader,setPercent,setAttachment,taskID) => {

   const formData = new FormData();

   formData.append('file',selectedFile)
   console.log('alazuuuuu')

   var xhr = new XMLHttpRequest();
   xhr.responseType = "json";
   xhr.upload.addEventListener("progress",(e)=> {ProgressHandler(e,setLoader,setPercent)}, false);
   xhr.addEventListener("load",(e)=> {SuccessHandler(e,setLoader,setAttachment)}, false);
   xhr.addEventListener("error",(e)=> {ErrorHandler(e,setLoader)}, false);
   xhr.addEventListener("abort",(e)=> {AbortHandler(e,setLoader)}, false);
   xhr.open("POST", `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/task/file/upload`);
   xhr.setRequestHeader('taskID', taskID);
 ...
 const SuccessHandler = (e,setLoader,setAttachment) => {
   setLoader(false)
...
export default function UploadFile({spaceID, projectID, selectedFile,setAttachment,taskID}) {
   ...
   useEffect(()=>{
      HandleUploadFile(spaceID, projectID,selectedFile,setLoader,setPercent,setAttachment,taskID)
   },[])
