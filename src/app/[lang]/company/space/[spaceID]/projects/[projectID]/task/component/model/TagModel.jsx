...
export default function TagModel({spaceID,setTagModel, selectedTags, setSelectedTags,projectID}) {
   ...
   useEffect(() => {
      ...
      const abortController = new AbortController();
         ...
         fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/en/company/space/${spaceID}/project/${projectID}/task/tag?spaceID=${spaceID}&projectID=${projectID}`,
            {
