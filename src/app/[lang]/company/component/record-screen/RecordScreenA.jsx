...
async function startRecording (setStartRecord,setSecondTimeRecord,setLoader,setPercent,setModel,setDownload,setFileName,setStatus) {
    let count;
    await setupStream();
    if(stream && audio) {
        ...
        recorder.start(200);
        console.log("Recording has starting...")
...
export default function RecordScreen() {
    ...
    useEffect(()=>{
        ...
        return (
            ...
            onClick={(e)=>{
                startRecording(setStartRecord,setCountTimeRecord,setLoader,setPercent,setModel,setDownload,setFileName,setStatus)
            }}>
