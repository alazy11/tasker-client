...
<TopMiddleNav setEmployee={setEmployee} />
...
Archive
      ...
      <div className='flex items-center'>
         ...
         onChange={(e) => {
            ...
            startTransition(() => {
               inputHandler(e.target.value, setEmployeeElement);
            });
         }}
         />
         </div>
       ...
       <div className="relative grow min-h-0 grid grid-container-spaces">
            ...
            <table className="min-w-800 space-table w-full">
               <thead className="sticky top-0">
                  <tr className="h-8 back-nav-side text-656f7d text-xs border-bottom-f0f1f3">
                     ...
                     <th className="font-medium  w-30% text-start">EMAIL</th>
                     <th className="font-medium  w-1/5 text-start">JOB</th>
                     <th className="font-medium w-10% text-start">ACTION</th>
                  </tr>
               </thead>
               <tbody>
         ...
         {
            employee && <JoinEmployee company={user} setEmployee={setEmployee} />
         }
