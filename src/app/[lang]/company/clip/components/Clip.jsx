...
export default function Clip({item}) {
    ...
    return (
        ...
        <div className="cu-clip-card__content">
            <a href={`/en/company/clip/${item.clip_id}`} className="cu-clip-card__link ">
            ...
            <div className="cu-clip-card__actions">
                ...
                <div>
                    <button className={`btn-normal clip-copy-button ${clipOpt && 'active'}`} onClick={(e)=>{
                        ...
                        <div _nghost-ng-c4133689536="">
                        <svg className="block w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="cu-clip-card__footer">
            ...
            <div className="cu-clip-card__editable-title">

                {
                    ...
                    <textarea rows={1} value={clipTitle} autoFocus name="clipName" onChange={(e)=>{
                        const textarea = e.currentTarget;
                ...
                <a href={`/en/company/clip/${item.clip_id}`} className="cu-clip-card__title">
                {clipName}
                </a> 
