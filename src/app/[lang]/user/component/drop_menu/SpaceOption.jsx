...
export default function SpaceOption({setSpaceOptionModel,folderLeft, folderTop,spaceID,getSpace,setGetSpace,setMessage,setProgress,setSave}) {
   ...
   return (
      ...
      >
         <div
            ...
            style={{ top:folderTop+'px',left:folderLeft+'px',width: "224px", top: "36%"}}
         >
            <ul>
