...
function deleteNote(note_id,refresh, setRefresh) {
    fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/en/user/note?note_id=${note_id}`, {
       method:'DELETE',
       credentials: "include",
       headers: {
...
export default function List({setNotesModel,setNote}) {
    ...
    useEffect(()=>{
        ...
        fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/en/user/note`, {
           credentials: "include",
           headers: {
              "cache-control": "no-cache",
           }
