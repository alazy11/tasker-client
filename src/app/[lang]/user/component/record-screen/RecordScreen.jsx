...
fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/en/user/clip/save`, {
    method:'POST',
    credentials: "include",
    headers: {
...
const HandleUploadFile = (selectedFile,setLoader,setPercent,setModel) => {
    ...
    xhr.open("POST", `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/user/clip`);
...
export default function RecordScreen() {
    ...
    useEffect(()=>{
        ...
        return (
            ...
            <div>
            <button className="flex items-center p-2 btn-top-nav rounded-md bg-transparent text-white  dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" onClick={(e)=>{
