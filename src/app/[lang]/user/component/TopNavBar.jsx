...
import socket from "@/app/socketUser";
import MeetingNotification from "../../component/MeetingNotification";
...
export default function TopNavBar({lang, dic,setShowMenu, showMenu, setShowOverlay, showOverlay,user}) {
   ...
   return (
      <>
      <header className="z-40" style={{zIndex:'100'}}>
         <div className="back-nav h-12 flex items-center">
            ...
            <button type="button" class="collapse-icon w-8 h-8 rounded-md flex items-center hover:bg-gray-500/10 dark:hover:bg-dark-light/10 dark:text-white-light transition duration-300" onClick={(e)=>{
                        if(showMenu === '') {
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="m-auto rotate-270"><path d="M19 11L12 17L5 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path opacity="0.5" d="M19 7L12 13L5 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg></button>
            </div>
...
New
                  ...
                  <div>
                     <button className="flex items-center rounded-md p-2 btn-top-nav  bg-transparent text-white  dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60">
                     <svg width={20} height={20} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14.047 3.304A7 7 0 0 0 5 10v3.722a.67.67 0 0 1-.196.474l-.511.511a1 1 0 0 0-.293.707V16a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-.586a1 1 0 0 0-.293-.707l-.51-.51a.67.67 0 0 1-.197-.475V10c0-.176-.006-.351-.02-.524" />
                  ...
                  <div>
                     <button className="flex btn-top-nav rounded-md  items-center p-2  bg-transparent text-white  dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60" onClick={(e)=>{
                        setNoteModel(true)
                     }}>
                     <svg width={20} height={20} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M9 16h6" />
                  ...
                  <div className="dropdown shrink-0">
                     <button
                        type="button"
                        className="block p-2 btn-top-nav  bg-transparent rounded-md text-white  dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                     >
<svg width={20} height={20} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M14 2v4a2 2 0 0 0 2 2h4" />
                  ...
                  <div className="dropdown shrink-0">
                     <button
                        type="button"
                        className="relative block p-2 btn-top-nav rounded-md bg-transparent text-white  dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                     >
                        <span>
