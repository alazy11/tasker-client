...
export default function PageEmployee({ user }) {
   ...
   return (
      <div className="relative grow min-h-0 grid grid-container-spaces">
         <div className={`grow overflow-auto scroll-bar relative ${employee ? 'mr-60' : ''}`}>
            <table className="min-w-800 space-table w-full">
               <thead className="sticky top-0">
                  <tr className="h-8 back-nav-side text-656f7d text-xs border-bottom-f0f1f3">
                     ...
                     <th className="font-medium  w-30% text-start">NAME</th>
                     <th className="font-medium  w-40% text-start">EMAIL</th>
         ...
         {
            employee && <JoinEmployee setEmployee={setEmployee} />
         }
