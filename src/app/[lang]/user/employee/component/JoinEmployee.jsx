...
export default function JoinEmployee({ setEmployee }) {
   ...
   return (
      <div className="absolute right-0 top-0 h-full bg-white z-50 w-60 border-top-e8eaed border-left-e8eaed">
         <div className="flex flex-col h-full">
            ...
            <div className="w-full overflow-auto flex-1 scroll-bar pb-2.5 h-5/6">
               <ul className="flex flex-col gap-1">
                  ...
                  {
                     model && <UserInformation user={user} setModel={setModel} setNotification={setNotification} />
                  }

                  {
                     notification && <SuccessNotification setNotification={setNotification} > Order has been Send. </SuccessNotification>
                  }
