...
<path d="M3 16h7v5H3z"></path>
               ...
               <li className='flex items-center'>
                  <a href={`/en/user/space/${spaceID}/projects`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects` ? 'active' : ''}`}>
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width="100%" height="100%" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M9.225 4.378 12 7.5H3V4.875a.75.75 0 0 1 .75-.75h4.912a.75.75 0 0 1 .563.253Z"></path>
               ...
               <li className='flex items-center'>
                  <a href={`/en/user/space/${spaceID}/members`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/members` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width="100%" height="100%" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
               ...
               <li className='flex items-center'>
               <a href={`/en/user/space/${spaceID}/chat`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/chat` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width="100%" height="100%" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
