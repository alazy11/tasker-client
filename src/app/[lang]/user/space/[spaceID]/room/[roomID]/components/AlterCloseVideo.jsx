...
<div className="relative">
                    ...
                    <div className="relative">
                    <div className=" w-16 h-16 relative select-none flex items-center justify-center text-3xl font-normal rounded-full color-avatar uppercase " style={{backgroundColor:'rgb(123, 104, 238)'}} >
                        {user.public_name[0]}
                    </div>
                </div>
                 )}
