...
export default function VideoOption() {
...
<svg width={"1.2rem"} height={"1.2rem"} className="block relative z-10" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M8 23h8" />
                ...
                <div className=" w-10 h-10 rounded-full  video-control_item-no-voice video-control_item-no-shadow flex items-center justify-center text-white cursor-pointer" onClick={(e)=>{
// stream.getVideoTracks().forEach(track => track.enabled = !track.enabled);
