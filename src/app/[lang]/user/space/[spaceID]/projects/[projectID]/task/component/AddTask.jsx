...
function createTask({projectID,title,state,manager,priority,selectedTags,phases,startDate,endDate,desc,folderPath,setLoader,setNotification,setModel,spaceID,referesh,setReferesh }) {
   setLoader(true)
   const task = {
                  ...
                  <div className="sticky w-full back-nav-side bottom-0 flex items-center justify-between border-top-e8eaed p-4 ltr:pl-6 rtl:pr-6 ">
                     ...
                     {loader ? (
                        ...
                        <button
                           ...
                           onClick={(e) => {
                              if(process === 'add')
                              createTask({space_id,projectID,title,state,manager:manager[0].user_id,priority,selectedTags,phases,startDate,endDate,desc,folderPath,setNotification,setLoader,setModel,spaceID,referesh,setReferesh });
                              else
