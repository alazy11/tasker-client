...
export default function TopMiddleNav ({children,spaceID, setEmployee, projectID, active = false}) {
         ...
         <div className='flex items-center flex-grow'>
            <ul className='flex self-stretch gap-1'>
               <li className='flex items-center'>
                  <a href="#" className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}` ? 'active' : ''}`}>
...
<path d="M3 16h7v5H3z"></path>
               ...
               <li className='flex items-center'>
                  <a href={`/en/company/space/${spaceID}/projects/${projectID}/folders`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}/folders` ? 'active' : ''}`}>
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width={'100%'} height={'100%'} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M9.225 4.378 12 7.5H3V4.875a.75.75 0 0 1 .75-.75h4.912a.75.75 0 0 1 .563.253Z"></path>
               ...
               <li className='flex items-center'>
                  <a href={`/en/company/space/${spaceID}/projects/${projectID}/task`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}/task` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width={'100%'} height={'100%'} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 10H3" />
    <path d="M21 6H3" />
    ...
    <path d="M17 18H3" />
               ...
               <li className='flex items-center'>
                  <a href={`/en/company/space/${spaceID}/projects/${projectID}/plan`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}/plan` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width={'100%'} height={'100%'} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M3 10h18" />
               ...
               <li className='flex items-center'>
                  <a href={`/en/company/space/${spaceID}/projects/${projectID}/event`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}/event` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width={'100%'} height={'100%'} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
               ...
               <li className='flex items-center'>
                  <a href={`/en/company/space/${spaceID}/projects/${projectID}/timeline`} className={`relative h-7 w-full rounded-md ps-1.5 pe-1.5 flex top-item items-center gap-1 hover:bg-gray-100 ${path === `/en/company/space/${spaceID}/projects/${projectID}/timeline` ? 'active' : ''}`} >
                     <span className='w-4 h-4 text-656f7d'>
                     <svg width={'100%'} height={'100%'} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 21v-7" />
    <path d="M4 10V3" />
