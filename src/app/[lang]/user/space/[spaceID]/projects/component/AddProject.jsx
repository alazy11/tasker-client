...
function createProject({space_id,title,state,manager,priority,selectedTags,phases,startDate,endDate,desc,setLoader,setNotification,setModel,spaceID,referesh,setReferesh }) {
   setLoader(true)
   const project = {
      space_id,title,state,manager,priority,selectedTags,phases,startDate,endDate,desc
   }


   fetch(`http://localhost:4040/en/company/space/${spaceID}/project`, {
      method:'POST',
      credentials: "include",
      headers: {
...
export default function AddProject({ setModel, spaceID, referesh,setReferesh }) {
                           ...
                           <span >
                              Title...
                                 ...
                                 <textarea
                                    ...
                                    // className="text-3xl font-bold leading-5 w-full min-h-9 outline-0"
                              ...
                              <div>
                                 <h2 className="text-xl leading-10">Plan</h2>
                                       ...
                                       <div>
                                          <div className="w-full flex items-center text-sm font-normal min-h-9 color-700 rounded-md pl-1.5 pr-1.5 select-none hover:bg-gray-50">
                                             ...
                                             <input
                                                ...
                                                placeholder="Number of plan phases..."
                                                onChange={(e) => {
