...
const HandleUploadFile = (task,selectedFile,setLoader,setPercent,taskID) => {
   ...
   xhr.open("POST", `${process.env.NEXT_PUBLIC_BACKEND_URL}/en/user/space/${task.spaceID}/project/${task.project_id}/request/upload`);
...
export default function UploadFile({user, task, selectedFile,taskID}) {
   ...
   const [editFile, setEditFile] = useState(false);
      ...
      useEffect(()=>{
         HandleUploadFile(task,selectedFile,setLoader,setPercent,taskID)
      },[])
