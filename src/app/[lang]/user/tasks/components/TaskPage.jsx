...
export default function TaskPage ({user}) {
    ...
    return (
        ...
        <div className="grow  relative board-view scroll-bar gap-2">
            ...
            <TaskGroup state="todo" setItem={setItem} setModelFile={setModelFile} tasks={taskTodo} setTask={setTask} stateText={'to do'} />
            ...
            <TaskGroup state="complete" setItem={setItem} setModelFile={setModelFile} tasks={taskComplete}  setTask={setTask}  stateText={"complete"} />
